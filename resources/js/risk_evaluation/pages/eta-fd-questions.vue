        ...
        <div class="card shadow">
            ...
            <div class="card-body bg-light py-3 px-4">
                ...
                <div class="w-100 text-center mb-3" v-if="sub_sector_info != null">
                    <p class="btn btn-primary py-2 px-5 rounded-pill d-inline-block m-0 mb-2"><strong>{{ sub_sector_info.title }}</strong></p>
                </div>
...
export default {
    ...
    methods: {
        getQuestions() {
            ...
            ApiService.POST(ApiRoutes.EvaluationTechnicalQuestions, {sector: THIS.domain, sub_sector: THIS.sub_sector, category: this.risk_evaluation.category}, (res) => {
        ...
        SubmitQuestions() {
            ...
            if (THIS.sub_sector != undefined) {
                THIS.risk_evaluation.answers['domain_' + THIS.domain + '_' + THIS.sub_sector] = object;
            } else {
                THIS.risk_evaluation.answers['domain_' + THIS.domain] = object;
            }
