        ...
        <div class="card shadow">
            ...
            <div class="card-body bg-light py-3 px-4">
                ...
                <div class="w-100 text-center mb-3" v-if="questions.length > 0">
                    <p class="btn btn-primary py-2 px-5 rounded-pill d-inline-block m-0 mb-2"><strong>Fair Decision Analysis</strong></p>
                </div>
...
export default {
    ...
    methods: {
        getQuestions() {
            ...
            ApiService.POST(ApiRoutes.EvaluationFdQuestions, {}, (res) => {
        ...
        SubmitQuestions() {
            ...
            THIS.risk_evaluation.answers['fd'] = object;
