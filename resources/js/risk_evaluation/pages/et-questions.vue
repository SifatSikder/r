        ...
        <div class="card shadow">
            ...
            <div class="card-body bg-light py-3 px-4">
                ...
                <div class="w-100 text-center mb-3" v-if="questions.length > 0">
                    <p class="btn btn-primary py-2 px-5 rounded-pill d-inline-block m-0 mb-2"><strong>{{ groups[currentGroupIndex].title }}</strong></p>
                </div>
                <div class="w-100 mb-3" v-if="risk_evaluation != null">
                                            ...
                                            <div class="col-md-12">
                                                <ul class="list-unstyled px-2 px-lg-5">
                                                    <li class="mt-3" v-if="q.option_1.title !== ''">
                                                        <template v-if="q.type === 'Regular'">
                                                            <p class="text-secondary m-0 p-0"><span v-html="q.option_1.title"></span></p>
                                                        </template>
                                                        <template v-if="q.type === 'Multiple_Answers'">
                                                            <p class="text-dark m-0 p-0"><strong v-html="q.option_1.title"></strong></p>
                                                            <p class="text-secondary m-0 p-0"><span v-html="q.option_1.desc"></span></p>
                                                        </template>
                                                        <div class="w-100 mt-2 custom-radio-checkbox">
                                                            <div class="form-check form-check-inline ps-0">
                                                                <input class="form-check-input-custom"
                                                                       :checked="isCheckedAnswer(q._id+'_q1', '0')"
                                                                       :name="q._id+'_q1'" type="radio" :id="'qCheck1Y'+i" value="0" required>
                                                                <label class="form-check-label" :for="'qCheck1Y'+i">Yes</label>
                                                            </div>
                                                            <div class="form-check form-check-inline ps-0">
                                                                <input class="form-check-input-custom"
                                                                       :checked="isCheckedAnswer(q._id+'_q1', q.option_1.risk_value)"
                                                            ...
                                                            <div class="form-check form-check-inline ps-0">
                                                                <input class="form-check-input-custom"
                                                                       :checked="isCheckedAnswer(q._id+'_q1', '-1')"
                                                                       :name="q._id+'_q1'" type="radio" :id="'qCheck1NA'+i" value="-1" required>
                                                    ...
                                                    <template v-if="q.type === 'Multiple_Answers'">
                                                        <li class="mt-5" v-if="q.option_2.title !== ''">
                                                            <p class="text-dark m-0 p-0"><strong v-html="q.option_2.title"></strong></p>
                                                            <p class="text-secondary m-0 p-0"><span v-html="q.option_2.desc"></span></p>
                                                            <div class="w-100 mt-2 custom-radio-checkbox">
                                                                <div class="form-check form-check-inline ps-0">
                                                                    <input class="form-check-input-custom"
                                                                           :checked="isCheckedAnswer(q._id+'_q2', '0')"
                                                                           :name="q._id+'_q2'" type="radio" :id="'qCheck2Y'+i" value="0" required>
                                                                    <label class="form-check-label" :for="'qCheck2Y'+i">Yes</label>
                                                                </div>
                                                                <div class="form-check form-check-inline ps-0">
                                                                    <input class="form-check-input-custom"
                                                                           :checked="isCheckedAnswer(q._id+'_q2', q.option_2.risk_value)"
                                                                ...
                                                                <div class="form-check form-check-inline ps-0">
                                                                    <input class="form-check-input-custom"
                                                                           :checked="isCheckedAnswer(q._id+'_q2', '-1')"
                                                                           :name="q._id+'_q2'" type="radio" :id="'qCheck2NA'+i" value="-1" required>
                                                                    <label class="form-check-label" :for="'qCheck2NA'+i">NA</label>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="mt-5" v-if="q.option_3.title !== ''">
                                                            <p class="text-dark m-0 p-0"><strong v-html="q.option_3.title"></strong></p>
                                                            <p class="text-secondary m-0 p-0"><span v-html="q.option_3.desc"></span></p>
                                                            <div class="w-100 mt-2 custom-radio-checkbox">
                                                                <div class="form-check form-check-inline ps-0">
                                                                    <input class="form-check-input-custom"
                                                                           :checked="isCheckedAnswer(q._id+'_q3', '0')"
                                                                           :name="q._id+'_q3'" type="radio" :id="'qCheck3Y'+i" value="0" required>
                                                                    <label class="form-check-label" :for="'qCheck3Y'+i">Yes</label>
                                                                </div>
                                                                <div class="form-check form-check-inline ps-0">
                                                                    <input class="form-check-input-custom"
                                                                           :checked="isCheckedAnswer(q._id+'_q3', q.option_3.risk_value)"
                                                                ...
                                                                <div class="form-check form-check-inline ps-0">
                                                                    <input class="form-check-input-custom"
                                                                           :checked="isCheckedAnswer(q._id+'_q3', '-1')"
                                                                           :name="q._id+'_q3'" type="radio" :id="'qCheck3NA'+i" value="-1" required>
                                                                    <label class="form-check-label" :for="'qCheck3NA'+i">NA</label>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="mt-5" v-if="q.option_4.title !== ''">
                                                            <p class="text-dark m-0 p-0"><strong v-html="q.option_4.title"></strong></p>
                                                            <p class="text-secondary m-0 p-0"><span v-html="q.option_4.desc"></span></p>
                                                            <div class="w-100 mt-2 custom-radio-checkbox">
                                                                <div class="form-check form-check-inline ps-0">
                                                                    <input class="form-check-input-custom"
                                                                           :checked="isCheckedAnswer(q._id+'_q4', '0')"
                                                                           :name="q._id+'_q4'" type="radio" :id="'qCheck4Y'+i" value="0" required>
                                                                    <label class="form-check-label" :for="'qCheck4Y'+i">Yes</label>
                                                                </div>
                                                                <div class="form-check form-check-inline ps-0">
                                                                    <input class="form-check-input-custom"
                                                                           :checked="isCheckedAnswer(q._id+'_q4', q.option_4.risk_value)"
                                                                ...
                                                                <div class="form-check form-check-inline ps-0">
                                                                    <input class="form-check-input-custom"
                                                                           :checked="isCheckedAnswer(q._id+'_q4', '-1')"
                                                                           :name="q._id+'_q4'" type="radio" :id="'qCheck4NA'+i" value="-1" required>
            ...
            <div class="card-footer py-3 d-flex align-items-center justify-content-between">
                ...
                <div class="">
                    <router-link v-if="currentGroupIndex > 0" class="btn btn-lg btn-secondary rounded-pill px-5 me-2" :to="{name: 'AlmostDone'}">Skip</router-link>
...
export default {
    ...
    watch: {},
    methods: {
        isCheckedAnswer(qq, vv) {
            const step = this.currentGroupIndex + 1;
            if (this.risk_evaluation.answers['domain_' + step] !== null) {
                if (this.risk_evaluation.answers['domain_' + step][qq] === vv) {
                    return true
                }
            }
            return false;
        ...
        evaluationDetails() {
            let THIS = this;
            ApiService.POST(ApiRoutes.RiskEvaluationDetails, {evaluation_id: this.evaluation_id}, (res) => {
                if (parseInt(res.status) === 200) {
                    THIS.risk_evaluation = res.evaluation;
        ...
        evaluationGroups() {
            let THIS = this;
            ApiService.POST(ApiRoutes.EvaluationGroups, {domain: null}, (res) => {
                if (parseInt(res.status) === 200) {
                    THIS.groups = res.data;
                    THIS.getQuestions(THIS.groups[THIS.currentGroupIndex].title);

                    if (this.evaluation_id === undefined) {
                        let answers = {}
                        res.data.forEach(function (v) {
                            answers['domain_' + v.uid] = null;
                        });
                        THIS.risk_evaluation.answers = answers;
                    }
                }
            })
        },
        getQuestions(group) {
            ...
            ApiService.POST(ApiRoutes.EvaluationTechnicalQuestions, {group: group}, (res) => {
                if (parseInt(res.status) === 200) {
        ...
        SubmitQuestions() {
            ...
            this.risk_evaluation.answers['domain_' + this.groups[this.currentGroupIndex].uid] = object;
            localStorage.setItem('risk_evaluation', JSON.stringify(this.risk_evaluation));
            if ((this.groups.length - 1) > this.currentGroupIndex) {
        ...
        goBack() {
            if (this.currentGroupIndex < 1) {
                if (this.evaluation_id === undefined || this.evaluation_id === null) {
    ...
    created() {
        this.evaluation_id = this.$route.query.ev;
        this.currentGroupIndex = parseInt(this.$route.query.cgr ?? 0);
        if (this.evaluation_id !== undefined) {
            ...
            if (localStorage.getItem('risk_evaluation') == null) {
                ...
                this.risk_evaluation.category = 'et';
            }
        }
