                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-5">
                                    <div class="w-100 p-5 shadow">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3" v-if="settings.training.banner_full !== null">
                                                    <img :src="settings.training.banner_full" style="max-width: 100%; height: 150px;border-radius: 20px">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="banner_title" v-model="settings.training.banner_title" placeholder="Banner Title">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="banner_intro" v-model="settings.training.banner_intro" placeholder="Banner Intro">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" v-model="settings.training.video_preview" name="video_preview" placeholder="Place a Youtube video URL here">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-100 p-5 shadow">
                                        <div class="row">
                                            <div class="col-lg-12 mb-5">
                                                ...
                                                <QuillEditor v-model:content="settings.training.training_content" contentType="html" theme="snow" toolbar="full" style="height: 400px"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        attachFile: function (event) {
            ...
            ApiService.UPLOAD(ApiRoutes.MEDIA, formData, (res) => {
                ...
                if (parseInt(res.status) === 200) {
                    this.settings.training.banner = res.data.file_path;
                    this.settings.training.banner_full = res.data.full_file_path;
                }
            })
        },
        updateWebSettings() {
        ...
        GetWebSettings() {
            this.Loading = true;
            ApiService.POST(ApiRoutes.WebsiteSettings + '/training', {}, (res) => {
                this.Loading = false;
                if (parseInt(res.status) === 200) {
                    this.settings.training = res.data.settings;
                }
            })
        }
    },
