                ...
                <form class="w-100" @submit.prevent="updateWebSettings">
                    <div class="card question-holder">
                        <div class="card-header bg-white py-3 d-flex justify-content-between sticky-top">
                            <h4 class="m-0"><strong class="text-dark">Certification Settings</strong></h4>
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-5">
                                    <div class="w-100 p-5 shadow">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3" v-if="settings.certification.banner_full !== null">
                                                    <img :src="settings.certification.banner_full" style="max-width: 100%; height: 150px;border-radius: 20px">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="banner_title" v-model="settings.certification.banner_title" placeholder="Banner Title">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="banner_intro" v-model="settings.certification.banner_intro" placeholder="Banner Intro">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
export default {
    ...
    methods: {
        attachFile: function (event) {
            ...
            ApiService.UPLOAD(ApiRoutes.MEDIA, formData, (res) => {
                ...
                if (parseInt(res.status) === 200) {
                    this.settings.certification.banner = res.data.file_path;
                    this.settings.certification.banner_full = res.data.full_file_path;
                }
            })
        },
        updateWebSettings() {
        ...
        GetWebSettings() {
            this.Loading = true;
            ApiService.POST(ApiRoutes.WebsiteSettings + '/certification', {}, (res) => {
                this.Loading = false;
                if (parseInt(res.status) === 200) {
                    this.settings.certification = res.data.settings;
                }
            })
        }
    },
