                ...
                <form class="w-100" @submit.prevent="updateWebSettings">
                    <div class="card question-holder">
                        <div class="card-header bg-white py-3 d-flex justify-content-between sticky-top">
                            <h4 class="m-0"><strong class="text-dark">Cookie Policy Settings</strong></h4>
                                ...
                                <div class="col-lg-12 mb-5">
                                    <div class="w-100 p-5 shadow">
                                        <div class="form-group mb-3">
                                            <label class="form-label"><strong>Cookie Policy</strong></label>
                                            <QuillEditor v-model:content="settings.cookie_policy" contentType="html" theme="snow" toolbar="minimal" style="height: 400px"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        GetWebSettings() {
            this.Loading = true;
            ApiService.POST(ApiRoutes.WebsiteSettings + '/cookie_policy', {}, (res) => {
                this.Loading = false;
                if (parseInt(res.status) === 200) {
                    this.settings.cookie_policy = res.data.settings;
                }
            })
        }
    },
