                ...
                <form class="w-100" @submit.prevent="updateWebSettings">
                    <div class="card question-holder">
                        <div class="card-header bg-white py-3 d-flex justify-content-between sticky-top">
                            <h4 class="m-0"><strong class="text-dark">Fair Decision Settings</strong></h4>
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-5">
                                    <div class="w-100 p-5 shadow">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3" v-if="settings.fair_decision.banner_full !== null">
                                                    <img :src="settings.fair_decision.banner_full" style="max-width: 100%; height: 150px;border-radius: 20px">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="banner_title" v-model="settings.fair_decision.banner_title" placeholder="Banner Title">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="banner_intro" v-model="settings.fair_decision.banner_intro" placeholder="Banner Intro">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-100 p-5 shadow">
                                        <div class="row">
                                            <div class="col-lg-12 mb-5">
                                                ...
                                                <QuillEditor v-model:content="settings.fair_decision.content" contentType="html" theme="snow" toolbar="full" style="height: 400px"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        attachFile: function (event) {
            ...
            ApiService.UPLOAD(ApiRoutes.MEDIA, formData, (res) => {
                ...
                if (parseInt(res.status) === 200) {
                    this.settings.fair_decision.banner = res.data.file_path;
                    this.settings.fair_decision.banner_full = res.data.full_file_path;
                }
            })
        },
        updateWebSettings() {
        ...
        GetWebSettings() {
            this.Loading = true;
            ApiService.POST(ApiRoutes.WebsiteSettings + '/fair_decision', {}, (res) => {
                this.Loading = false;
                if (parseInt(res.status) === 200) {
                    this.settings.fair_decision = res.data.settings;
                }
            })
        }
    },
