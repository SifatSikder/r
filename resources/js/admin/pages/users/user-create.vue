...
export default {
    ...
    methods: {
        ...
        CreateUser() {
            ...
            ApiService.POST(ApiRoutes.CreateUser, this.user, (res) => {
                this.Loading = false;
                if (parseInt(res.status) === 200) {
