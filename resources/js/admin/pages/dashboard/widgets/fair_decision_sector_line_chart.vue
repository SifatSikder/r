<template>
    ...
    <div class="card mb-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <strong class="text-black-50">Fair Decision Domains</strong>
...
export default {
    ...
    methods: {
        evaluation_sector_charts(){
            ...
            ApiService.POST(ApiRoutes.FairDecisionDomainsCharts, {selected_date: this.selected_date}, (res) => {
                if (parseInt(res.status) === 200) {
                    this.data.labels = res.data.labels;
                    res.data.sectors.forEach((v) => {
