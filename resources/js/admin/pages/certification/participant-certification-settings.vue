                    ...
                    <form class="w-100" @submit.prevent="SaveSettings">
                        <div class="card question-holder">
                            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                                <h4 class="m-0"><strong class="text-secondary">Participant Certificates Settings</strong></h4>
                                <div class="">
                                    <router-link class="btn btn-sm btn-secondary rounded-pill px-3 me-2" :to="{name: 'ParticipationCertification'}">Back</router-link>
...
export default {
    ...
    methods: {
        ...
        getSettings() {
            this.Loading = true;
            ApiService.POST(ApiRoutes.EvaluationCertificateSettings, {type: 'workshop'}, (res) => {
                if (parseInt(res.status) === 200) {
