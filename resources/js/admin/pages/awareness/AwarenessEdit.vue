                    ...
                    <form class="w-100" @submit.prevent="UpdateCourse">
                        <div class="card question-holder">
                            <div class="card-header bg-white py-3 d-flex justify-content-between sticky-top">
                                <h4 class="m-0"><strong class="text-dark">Update Awareness Course</strong></h4>
                                <div class="">
                            ...
                            <div class="card-body p-2 p-lg-5" v-if="course !== null">
                                <div class="row">
                                    <div class="col-lg-12">
...
export default {
    ...
    methods: {
        UpdateCourse() {
            ...
            ApiService.POST('/api/secure/admin/evaluation/awareness/update/'+this.course_id, this.course, (res) => {
                this.Loading = false;
