                ...
                <form class="w-100" id="sector_form" @submit.prevent="Manage">
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <h4 class="m-0 p-0">Evaluation Sectors</h4>
                        </div>
                        <div class="card-body">
            ...
            <div class="modal-content">
                <form id="sub_sector_form" @submit.prevent="ManageSubSectors" class="w-100">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Evaluation Sub Sectors</h1>
...
export default {
    ...
    methods: {
        ...
        Manage() {
            ...
            this.loading = true
            ApiService.POST_FORM_DATA(ApiRoutes.EvaluationSectorManage, sectors, (res) => {
                this.loading = false;
                if (parseInt(res.status) === 200) {
        ...
        getSubSectors(sector_uid) {
            ...
            ApiService.POST(ApiRoutes.EvaluationSectorGetAll, {parent_id: sector_uid}, (res) => {
                this.loading = false;
                if (parseInt(res.status) === 200) {
