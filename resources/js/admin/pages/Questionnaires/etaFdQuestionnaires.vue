            ...
            <div class="col-xl-9 col-md-8">
                ...
                <div class="card question-holder">
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                        <h4 class="m-0"><strong class="text-dark">Specific Industry Fair Decision Analysis Questions</strong></h4>
                    </div>
...
export default {
    ...
    methods: {
        ...
        addNewQuestion() {
            this.questions.push({
                _id: null,
                type: 'Multiple_Answers', //Regular, Multiple_Answers
                category: 'eta-fd',
        ...
        getAllSectors() {
            const THIS = this;
            ApiService.POST(ApiRoutes.fdSectorSectorGetAll, {}, (res) => {
                if (parseInt(res.status) === 200) {
