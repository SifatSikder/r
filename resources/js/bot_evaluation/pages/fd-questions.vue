        ...
        <div class="card shadow">
            ...
            <div class="card-body bg-light py-3 px-4">
                ...
                <div class="w-100 text-center mb-3" v-if="questions.length > 0">
                    <p class="btn btn-primary py-2 px-5 rounded-pill d-inline-block m-0 mb-2"><strong>Demo for Fair Decision Risk Evaluation</strong></p>
                </div>
...
export default {
    ...
    methods: {
        ...
        SubmitQuestions() {
            ...
            THIS.bot_evaluation.answers['fd'] = object;
    ...
    created() {
        ...
        if (localStorage.getItem('bot_evaluation') == null) {
            ...
            this.bot_evaluation.category = 'fd';
        }
    },
    mounted() {
        window.scrollTo(0, 0);
